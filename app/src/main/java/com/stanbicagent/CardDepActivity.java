...
public class CardDepActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ApplicationClass.get().getGlobalVals().setTranType("CARD DEPOSIT");
    }
    ...
    public void onClick(View view) {
            ...
            if (Utility.checkInternetConnection(this)) {
                ...
                if (Utility.isNotNull(amou)) {
                   ...
                   /* isLightLed = true;
                    ...
                    Intent intent = new Intent(CardDepActivity.this, NL_Card_Wdl_InsCard.class);
        ...
        if (view.getId() == R.id.tv2) {
            finish();
            Intent intent = new Intent(CardDepActivity.this, FTMenuActivity.class);
