...
public class NL_Dep_MenuActivity extends BaseActivity {
    GridView gridView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.nl_activity_ftmenu);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (position == 0) {
                    ...
                    editor.putString("card_ttype", "SDEP");
                    editor.putString("trans_type", "Depo");
                    editor.commit();
                    if (Utility.checkInternetConnection(NL_Dep_MenuActivity.this)) {
                        WDL_Check_Term_Status();
                    }
                } else if (position == 1) {
//                    startActivity(new Intent(NL_Dep_MenuActivity.this, CashDepoActivity.class));// TransActivity.class));
                    startActivity(new Intent(NL_Dep_MenuActivity.this, CashDepoTransActivity.class));// TransActivity.class));
                }
                if (fragment != null) {
    ...
    public void After_Card_Check() {
        if (check != 0) {
            ...
            if (tid.equals("") && mid.equals("") && mer_name.equals("") && fld_43.equals("")) {
                ...
                if (cked == 0) {
                    startActivity(new Intent(NL_Dep_MenuActivity.this, CardDepActivity.class));
                } else {
...
//        serial_no="01223125";
    ...
    public void Unpack_Key_Exchange_Data() {
        ...
        try {
            ...
            if (rpc.equals("00")) {
                ...
                Load_Keys_KE();
                startActivity(new Intent(NL_Dep_MenuActivity.this, NL_CardWdlTransAmountActivity.class));
            } else {
    ...
    public void setDialog(String title, String message) {
        new MaterialDialog.Builder(NL_Dep_MenuActivity.this)
                .title(title)
                .content(message)
    ...
    public void SetPop() {
        planetsList.clear();
        planetsList.add(new OTBList("Card Deposit", "057"));
        planetsList.add(new OTBList("Cardless Deposit", "058"));
