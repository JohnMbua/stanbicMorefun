...
public class ForceResetPin extends AppCompatActivity implements View.OnClickListener {
                        ...
                        if (confnpin.equals(npin)) {
                            if (npin.length() == 5 && oldpinn.length() == 5) {
                                if (Utility.findweakPin(npin)) {
                                    ...
                                    String params = CHANNEL_ID + usid + "/" + agentid + "/" + mobnoo + "/" + encrypted1 + "/";
                                    String lgparams = ApplicationConstants.CHANNEL_ID + usid + "/" + value + "/" + mobnoo;
    ...
    private void RetroDevReg(String params) {
        SecurityLayer.Log("RetroDevReg", "Inside Retro Dev Reg");
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                try {
                    ...
                    if (Utility.isNotNull(respcode) && Utility.isNotNull(responsemessage)) {
                        ...
                        if (respcode.equals("00")) {
                            if (!(datas == null)) {
                                SecurityLayer.Log("FCP","FCP datas not null");
                                ...
                                SecurityLayer.Log("Public Key +  finalparams >> ", pubkey + " - " + finalparams);
