...
public class NL_WDLMenuActivity extends BaseActivity {
    GridView gridView;
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (position == 0) {
                    ...
                    editor.commit();
                    if (Utility.checkInternetConnection(NL_WDLMenuActivity.this)) {
                        WDL_Check_Term_Status();
                    }
                } else if (position == 1) {
                    startActivity(new Intent(NL_WDLMenuActivity.this, WithdrawActivity.class));
                }
                if (fragment != null) {
    ...
    public void After_Card_Check() {
        if (check != 0) {
            ...
            if (tid.equals("") && mid.equals("") && mer_name.equals("") && fld_43.equals("")) {
                ...
                if (cked == 0) {
                    startActivity(new Intent(NL_WDLMenuActivity.this, NL_CardWdlTransAmountActivity.class));
                } else {
...
//            serial_no = "19990004";
    ...
    public void setDialog(String title, String message) {
        new MaterialDialog.Builder(NL_WDLMenuActivity.this)
                .title(title)
                .content(message)
